...
dropcc: true
vignette: >
  %\VignetteIndexEntry{scharpbama Function Validation Report}
...
source(here("vignettes", "evaluate_specification.R")) # deprecated functions
source(here("vignettes", "SCHARP_evaluate.R"))
